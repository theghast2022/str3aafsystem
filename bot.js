...
client.on('message', message => {
  ...
  if (message.author.id !== "506899150454128640") return;
...
client.on("message", message => {
    if (message.content === (prefix + "help")) {
     const embed = new Discord.RichEmbed() 
         ...
         __All Commands__
         rid ➼ عرض ملفك الشخصي
         rask ➼ البوت يسئلك اسئلة
         rserver ➼ احصائيات السيرفر
         ravatar ➼ عرض صورتك الشخصية
         rroll ➼ القرعة
         يعطيك رابط شغال ليوم واحد ➼ رابط
         rcount ➼ كم عضو بالسيرفر
         rhelp ➼ عرض هذه الرسالة
         rcut ➼ للعب لعبة كت تويت 
         rping ➼ لمعرفة سرعة استجابة البوت في الوقت الحالي
         rminc ➼ اسئلة عن ماين كرافت
         rinvite ➼ يقول لك كم واحد انت مدخل
         rnew ➼ لفتح تذكرة
          __Admins Commands__
         rban ➼ حظر العضو من السيرفر
         rkick ➼ طرد العضو من السيرفر
         rclear ➼ مسح الشات
         rcreateroles ➼ عمل رتب متكاملة للسيرفر
         rclear ➼ ل مسح الشات بعدد محدد
         rwarn ➼ لاعطاء الشخص تحذير
         rmoveall ➼ لسحب جميع الداخلين ب الفويس
         rvoicesetup ➼ تصنع فويس تشانل مكتوب فيها عدد الاونلاين يلي في الفويس 
         rmute ➼ لاعطاء الشخص ميوت
         runmute ➼ لفك الميوت عن الشخص
         rmc ➼ لقفل الشات
         rumc ➼ لفتح الشات 
         rbc ➼ رسالة جماعية
         robc ➼ رسالة جماعية فقط للاونلاين
         rebc ➼ رسالة جماعية ب امبيد
         ✧▬▬▬▬▬▬ BOT System ▬▬▬▬▬▬✧
       **  `)
...
client.on('message', message => {
    if (message.content === "rcreateroles") {
        ...
        if (message.member.voiceChannel == null) return message.channel.send(`**الرجاء الدخول لروم صوتي**`)
         ...
         client.on('guildMemberAdd', member => {
          ...
          const cuttweet = [
           ...
           client.on('message', message => {
             if (message.content.startsWith("rcut")) {
...
client.on("message", (message) => {
    /// ALPHA CODES
   if (message.content.startsWith("rnew")) {     /// ALPHA CODES
  ...
  if (message.content.startsWith("rclose")) {
        if (!message.channel.name.startsWith(`ticket-`)) return message.channel.send(`You can't use the close command outside of a ticket channel.`);
 
        message.channel.send(`هل أنت متأكد؟ بعد التأكيد ، لا يمكنك عكس هذا الإجراء!\n للتأكيد ، اكتب\`rconfirm\`. سيؤدي ذلك إلى مهلة زمنية في غضون 10 ثوانٍ وإلغائها`)
            .then((m) => {
                message.channel.awaitMessages(response => response.content === 'rconfirm', {
                        max: 1,
                        time: 10000,
                        errors: ['time'],
                    })    /// ALPHA CODES
